...
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Aquí pondrás tus archivos estáticos
]
...
# Configuración para navegación segura detrás de un proxy (como nginx)
...
FRONTEND_URL = config('FRONTEND_URL', default='https://tonytruckpart.com')
